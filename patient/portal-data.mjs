  ...
  return {
    ...
    patient: {
      ...
      insurance: [{
        ...
        planName: "Synthetic PPO",
        memberId: "SYNTHETIC-MEMBER-0000",
        groupNumber: "SYNTHETIC-GROUP",
      ...
      verification: {
        ...
        fields: {
          ...
          legalLastName: "verified",
          preferredName: "verified",
          dateOfBirth: "verified",
          sexAtBirth: "verified",
          genderIdentity: "verified",
          pronouns: "verified",
    ...
    supplements: [{
      name: "Synthetic vitamin D",
      dose: "1 synthetic tablet",
      frequency: "Daily",
      clinicalStatus: "active",
      instructions: "Patient-reported synthetic supplement for portal testing.",
    }],
    requests: [{
      type: "referral",
